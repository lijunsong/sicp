...
;; save the original apply, which means we shouldn't reload this file again
;; and again
      ...
      (let ((first (car clauses))
        ...
        (if (cond-else-clause? first)
            (if (null? rest)
                ...
                (error 'expand "ELSE clause isn't last -- COND->IF"
                       clauses))
...
;; tests are written in evaluator-regression-test.scm
